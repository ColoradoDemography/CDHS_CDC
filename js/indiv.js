...
var map, featureLayer, featureLayer2, pointLayer, legend;
...
function init() {
    ...
    dojo.byId("subtitle").innerHTML = "Source: Table B17024, ACS 2010-2014 5Y : Census Tracts";
}
...
function Clickhereformap(mainid) {
    ...
    if (pvt == "0") {
        povtext = "Percent at &lt; 50% Poverty: ";
    };
    if (pvt == "1") {
        povtext = "Percent at &lt; 75% Poverty: ";
    };
    if (pvt == "2") {
        povtext = "Percent at &lt; 100% Poverty: ";
    };
    if (pvt == "3") {
        povtext = "Percent at &lt; 125% Poverty: ";
    };
    if (pvt == "4") {
        povtext = "Percent at &lt; 150% Poverty: ";
    };
    if (pvt == "5") {
        povtext = "Percent at &lt; 175% Poverty: ";
    };
    if (pvt == "6") {
        povtext = "Percent at &lt; 185% Poverty: ";
    };
    if (pvt == "7") {
        povtext = "Percent at &lt; 200% Poverty: ";
    };
    if (pvt == "8") {
        povtext = "Percent at &lt; 300% Poverty: ";
    };
    if (pvt == "9") {
        povtext = "Percent at &lt; 400% Poverty: ";
    };
    if (pvt == "10") {
        povtext = "Percent at &lt; 500% Poverty: ";
    };
    if (pvt == "11") {
        povtext = "Percent &ge; 500% Poverty: ";
    };
