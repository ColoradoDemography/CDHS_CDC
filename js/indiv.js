...
function initOperationalLayer(map) {
	...
	featureLayer = new esri.layers.FeatureLayer("http://services.arcgis.com/IamIM3RJ5xHykalK/arcgis/rest/services/PovertyComprehensive_v3/FeatureServer/0", {
		mode : esri.layers.FeatureLayer.MODE_ONDEMAND,
		outFields : ["*"],
		infoTemplate : infoTemplate
	});
	
	featureLayer2 = new esri.layers.FeatureLayer("http://services.arcgis.com/IamIM3RJ5xHykalK/arcgis/rest/services/PovertyComprehensive_v3/FeatureServer/0", {
		mode : esri.layers.FeatureLayer.MODE_ONDEMAND,
		outFields : ["*"]
	});
	
	pointLayer = new esri.layers.FeatureLayer("http://services.arcgis.com/IamIM3RJ5xHykalK/arcgis/rest/services/SeniorCenters/FeatureServer/0", {
		mode : esri.layers.FeatureLayer.MODE_ONDEMAND,
		outFields : ["*"],
		infoTemplate : infoTemplate2
	});
	
	countyLayer = new esri.layers.FeatureLayer("http://services.arcgis.com/IamIM3RJ5xHykalK/ArcGIS/rest/services/CountyACSv4/FeatureServer/0", {
		mode : esri.layers.FeatureLayer.MODE_ONDEMAND
	});
	
	placeLayer = new esri.layers.FeatureLayer("http://services.arcgis.com/IamIM3RJ5xHykalK/arcgis/rest/services/Places2013_Inc/FeatureServer/0", {
		mode : esri.layers.FeatureLayer.MODE_ONDEMAND
	});	
...
function Clickhereformap(mainid) {
	...
	newobj.filename = "http://dola.colorado.gov/gis-php/phantomComprPoverty.html";
	newobj.lat = newy;
	newobj.lng = newx;
	...
	$.get("http://dola.colorado.gov/gis-php/comprpoverty.php", newobj, function() {
